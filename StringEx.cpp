...
{
	LPCTSTR m_pchData = (LPCTSTR)(*this); //+zep
...
{
	LPCTSTR m_pchData = (LPCTSTR)(*this); //+zep
	LPCTSTR lpsz, lpszRemainder = m_pchData, lpszret;
...
{
	LPCTSTR m_pchData = (LPCTSTR)(*this); //+zep
	LPCTSTR lpsz, lpszRemainder = m_pchData;
...
{
	LPCTSTR m_pchData = (LPCTSTR)(*this); //+zep
	LPCTSTR lpsz, lpszEnd, lpszRet, lpszRemainder = m_pchData ;
